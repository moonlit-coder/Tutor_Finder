        ...
        <div class="content">
          <div class="left-side">
            <div class="address details">
              ...
              <br>
              <div class="text-one">Mumbai University</div>
              <div class="text-two">Churchgate, 400018 </div>
            </div>
            <div class="phone details">
              <i class="fas fa-phone-alt"></i>
              <div class="topic">Phone</div>
              <br>
              <div class="text-one">+91 9082609300</div>
              <div class="text-two">+91 9321059056</div>
            </div>
            <div class="email details">
              <i class="fas fa-envelope"></i>
              <div class="topic">Email</div>
              <br>
              <div class="text-one">Sanika Bangar</div>
              <div class="text-two">sanikab.mca24@siescoms.sies.edu.in</div>
              <br>
              <div class="text-one">Amrita Aauji</div>
              <div class="text-two">Amritaa.mca24@siescoms.sies.edu.in</div>
            </div>
          </div>
          ...
          <form action="mailto:shravanik812@outlook.com" enctype="text/plain" method="post">
            <div class="input-box">

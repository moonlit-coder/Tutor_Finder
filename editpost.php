...
<div>
	<div>
		<div class="topnav">
			<a class="navlink" href="index.php" style="margin: 0px 0px 0px 100px;">Students</a>
			  	...
			  	<div class="itemrow">
					...
					<div class="itemrow">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="None">None</option>
							  <option value="Mumbai University">Nawas Shareef University</option>
							  <option value="Delhi University">Brac University</option>

	...
	<div class="nbody" >
        ...
        <div class="Search">
            ...
            <div class="s_contents">
                ...
                <div class="lc">
                    <p>Location</p>
                    <?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: Dombivli, Mumbai ">'; ?>
                </div>
                <div class="uni">
                    <p>University</p>
                    <select name="p_university" style="width: 180px;">
                      ...
                      <option value="None">None</option>
                      <option value="Mumabi University">Mumabi University</option>
					  <option value="Delhi University">Delhi University</option>
					  <option value="Shivaji University">Shivaji University</option>
					  <option value="YCMO University">Yashwantrao Chavan Maharashtra Open University</option>
					  <option value="Savitribai Phule Pune University">Savitribai Phule Pune University</option>
					  <option value="D. Y. Patil Education Society">D. Y. Patil Education Society</option>
                    </select>
                </div>

...
<body class="body1"  style="  background:fixed url(./image/bg1.jpg);background-size: 100%;">
	<center><div class="bars">
		...
		<div class="divp35"><input <?php $medium1=strstr($medium, "Hindi"); if($medium1 != '') echo 'checked'; ?> type="radio" name="medium_list[]" id="md" value="Hindi"><span>Hindi</span></div>
		<div class="divp35"><input <?php $medium1=strstr($medium, "Semi-English"); if($medium1 != '') echo 'checked'; ?> type="radio" name="medium_list[]" id="md" value="Semi-English"><span>Semi-Eng</span></div>
		<div class="divp35"><input <?php $medium1=strstr($medium, "Other"); if($medium1 != '') echo 'checked'; ?> type="radio" name="medium_list[]" id="md" value="Other"><span>Other</span></div>
		...
		<!-- <div class="divp35"><input type="checkbox" name="sub_list[]" value="Urdu"><span>Urdu</span></div> -->
			...
			<div class="divp35"><input type="checkbox" name="sub_list[]" value="Advanced Java"><span>Advanced Java</span></div>
			<div class="divp35"><input type="checkbox" name="sub_list[]" value="Advanced DBMS"><span>Advanced DBMS</span></div>
